...
Ceci dit on ne peut pas coercer vers nous même à ce moment la, on peut essayer de coercer vers une autre machine que nous controllons (la machine du collègue par exemple :))
