...
7. Vérifier que le ST est présent en cache
...
S4U2proxy -> Permet uniquement d'impersoner un user dont on a un ticket de service.
...
3. Dump le ST du compte usurpable
